#ejecutar trabajando desde /home/bioinfo1/aahumada/Unidad_2/Tarea2.1/code
#Individuos y variantes que tiene el archivo
vcftools --vcf /datos/compartido/ChileGenomico/GATK_ChGdb_recalibrated.autosomes.12262013.snps.known.vcf

#sitios que no tienen datos perdidos
...
#creacion de un archivo con los SNPs del cromosoma 4, desde el 0-2MB
...
#Reporte de variantes del archivo CLG_Chr4_0bp-2Mb.vcf
vcftools --vcf ../results/CLG_Chr4_0bp-2Mb.vcf 

#Reporte de cobertura promedio de los individuos del archivo CLG_Chr4_0bp-2Mb.vcf, Ademas crea el archivo profundidad_Chr4_0-2Mb.idepth
